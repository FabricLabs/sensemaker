        ...
        <Segment className='fade-in' style={{ maxWidth: '500px' }} loading={loading}>
          ...
          {(!tokenError && declined) && (
            <Message negative>
              ...
              <p>You have declined your invitation to Sensemaker. If you change your mind you can sign up at sensemaker.io. If you have any questions please contact <a href="mailto:support@sensemaker.io">support@sensemaker.io</a>.</p>
            </Message>
          )}
          {(!tokenError && cancelled) && (
            <Message positive>
              <Message.Header style={{ marginBottom: '1rem' }}>Congratulations!</Message.Header>
              <p>Your invitation remains active and can be used to register at any time. For assistance, contact us at <a href="mailto:support@sensemaker.io">support@sensemaker.io</a>.</p>
            </Message>
          )}
        </Segment>
      </div>

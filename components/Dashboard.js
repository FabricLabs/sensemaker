          ...
          <Container fluid style={containerStyle} onClick={() => this.closeSidebars()}>
            ...
            {this.state.isLoading ? null : (
              <Routes>
                ...
                <Route path="/documents/:fabricID" element={<DocumentView documents={this.props.documents} fetchDocument={this.props.fetchDocument} resetChat={this.props.resetChat} />} />

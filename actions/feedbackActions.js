...
const sendFeedback = (comment) => {
  return async (dispatch, getState) => {
    ...
    try {
      const timeoutPromise = createTimeoutPromise(15000, 'Feedback could not be sent due to a timeout error. Please check your network connection and try again.  For ongoing issues, contact our support team at support@sensemaker.io.')
